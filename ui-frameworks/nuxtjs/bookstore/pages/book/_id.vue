<template>
    <div class="book-detail page" :data-cms-id="book._doc">
        ...
        <!-- recommendations -->
        <BookList v-if="loaded" title="Recommendations" description="If you enjoy this book, we also recommend..." v-bind:books="recommendations" />
...
export default {
    ...
    async asyncData(context) {
        ...
        let recommendationsIds = book.recommendations.map(rec => rec._doc);
        let recommendations = (await $branch.queryNodes({"_doc": { "$in": recommendationsIds }})).rows
